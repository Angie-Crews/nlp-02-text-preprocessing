...
Γ£à Authorship Updated Across All Files:

- zensical.toml ΓÇö Site, repo, and social links point to Angie-Crews
- LICENSE ΓÇö Added Angie Crews as copyright holder
- CITATION.cff ΓÇö Angie Crews listed as primary author
- text_preprocessing_case.ipynb ΓÇö Author and repo links updated
- GitHub About section ΓÇö Linked to your GitHub Pages site
...
# P2: Text Preprocessing -- Phase 5: Chocolate Deep-Dive Summary

## Independent Application Goal

For Phase 5, I extended the chocolate work from Phase 4 by applying the same preprocessing workflow to a richer chocolate review dataset and adding deeper analysis.

## What I Added

- New dataset with labeled entries for `dark`, `milk`, and `white` chocolate:
  - `data/text_data_phase5.txt`
- New Phase 5 script:
  - `src/nlp/text_preprocessing_phase5.py`
- New Phase 5 notebook:
  - `notebooks/text_preprocessing_phase5.ipynb`
- New documentation page:
  - `docs/phase5-project.md`

## New Analysis Techniques

- Token frequency analysis on cleaned chocolate review text
- Top-token comparison by chocolate type
- Bigram (two-word phrase) frequency analysis
- Saved chart artifacts for documentation:
...
- Top cleaned terms emphasize chocolate tasting language, including `cocoa`, `sweetness`, `aroma`, and `vanilla`.
- Type-based comparison highlights different vocabulary across dark, milk, and white chocolate reviews.
- Bigram analysis adds context beyond single terms and surfaces repeated flavor phrases.
